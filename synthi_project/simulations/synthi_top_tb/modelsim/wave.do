...
add wave -noupdate -format Analog-Step -height 74 -max 8628.0000000000018 -min 44.0 -radix unsigned /synthi_top_tb/DUT/tone_gen_1/fm_dds_inst_gen(0)/inst_fm_dds/dds_car/phi_incr_i
...
add wave -noupdate -expand /synthi_top_tb/DUT/codec_controller_1/write_data_o
...
WaveRestoreCursors {{Cursor 1} {8539560 ns} 0}
...
update
WaveRestoreZoom {0 ns} {14321475 ns}
